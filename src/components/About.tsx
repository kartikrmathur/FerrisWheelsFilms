        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <p className="text-xl text-gray-600">
              We are a passionate team of filmmakers, storytellers, and creative minds dedicated to bringing your vision to life through the power of visual storytelling.
            </p>
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Pushing boundaries with innovative storytelling and cutting-edge production techniques.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Over 15 years of experience creating compelling content for global brands.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">State-of-the-art equipment and post-production facilities for superior results.</p>
                </div>
              </div>
            </div>
          </div>
