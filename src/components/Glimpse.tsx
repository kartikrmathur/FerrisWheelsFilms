...
const videos = [
  ...
  {
    thumbnail: "https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?auto=format&fit=crop&q=80",
  ...
  {
    thumbnail: "https://images.unsplash.com/photo-1585840887185-57cc492587e5?auto=format&fit=crop&q=80",
...
export default function Glimpse() {
  ...
  return (
    <section id="Glimpse" className="py-20 bg-gradient-to-br from-black via-gray-900 to-black text-white">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Step behind the scenes and discover the magic of our creative process
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {videos.map((video, index) => (
            ...
            >
              ...
              <div className={`absolute inset-x-0 bottom-0 h-1 bg-red-500 transform origin-left transition-transform duration-500 ${
